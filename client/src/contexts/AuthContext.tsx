...
function normalizeUser(raw: Record<string, unknown>): AuthUser {
  return {
    ...
    primaryConcerns: (raw.primaryConcerns || []) as string[],
    therapyExperience: (raw.therapyExperience || 'none') as string,
    ...
    currentMedications: (raw.currentMedications || []) as string[],
  };
}
...
function normalizeDoctor(raw: Record<string, unknown>): AuthDoctor {
  return {
    ...
    experienceYears: raw.experienceYears as number | null,
    specializations: (raw.specializations || []) as string[],
    qualifications: raw.qualifications as string | null,
    bio: raw.bio as string | null,
    clinicName: raw.clinicName as string | null,
    phone: raw.phone as string | null,
    acceptingPatients: (raw.acceptingPatients ?? 1) as number,
    createdAt: raw.createdAt as string,
  };
}
